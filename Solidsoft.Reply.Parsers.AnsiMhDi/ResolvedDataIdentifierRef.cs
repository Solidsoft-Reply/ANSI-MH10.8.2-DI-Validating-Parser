// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ResolvedDataIdentifierRef.cs" company="Solidsoft Reply Ltd">
...
// </copyright>
// <summary>
// Represents a resolved MH10.8.2 Data identifier and its associated data.
// </summary>
// --------------------------------------------------------------------------------------------------------------------

namespace Solidsoft.Reply.Parsers.AnsiMhDi;

using Solidsoft.Reply.Parsers.AnsiMhDi.Properties;
...
/// Represents a resolved MH10.8.2 Data identifier and its associated data.
/// </summary>
public ref struct ResolvedDataIdentifierRef : IResolvedEntityRef {
    /// <summary>
...
#pragma warning restore SA1311 // Static readonly fields should begin with upper-case letter
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="ResolvedDataIdentifierRef" /> struct.
    /// </summary>
    /// <param name="entity">
    ...
    /// </param>
    public ResolvedDataIdentifierRef(
        int entity,
        ...
        int index) {
            ...
            if (inverseExponent < -1) {
                AddException(new ParserException(identifier.ToString(), 2010, Resources.Ansi_Mh10_8_2_Error_012, true, 4));
            }
    }
    ...
    /// </param>
    public ResolvedDataIdentifierRef(ParserException exception, int characterPosition, int index = 0) {
        (Entity, InverseExponent, Sequence, IsFixedWidth, CharacterPosition, Index)
